...
<summary><strong>Do I need to connect a Bittensor wallet?</strong></summary>
...
<summary><strong>Why is Start training is disabled?</strong></summary>

Ensure that

* you are whitelisted (or TAH is open)
* the status shows **Connected**
* you’re on the latest app version
* and you have a stable network.

If you have any other issues please contact us through channels listed at [TAH Support](../../subnets/subnet-9-iota/support.md).
...
<summary><strong>How important is my internet connection?</strong></summary>

Very. A fast, stable connection is imperative: flaky Wi‑Fi, captive portals, or VPN drops can pause or remove you from a run.
