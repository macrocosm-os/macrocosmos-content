...
Training at Home (TAH) is an application that allows you to connect and partake in our decentralized AI training platform called [IOTA](../../subnets/subnet-9-iota/). The app is built for you to be able to contribute any hardware you have access to and get rewarded for your contributions. We aim to solve one of the biggest challenges in open-source AI today: the lack of a decentralized, community-driven, and efficient pre-training platform.
...
<figure><img src="../../.gitbook/assets/TAH-security-warning.png" alt=""><figcaption></figcaption></figure>
...
Once the app has launched properly you should be able to see the main dashboard:
