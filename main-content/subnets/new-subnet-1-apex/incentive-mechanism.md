---
description: Subnet 1 incentive and operational overview
---
...
For example, in the Compression competition — the first event on the subnet — the winning solution will not only directly enhance Subnet 9’s output but could also contribute to optimising data centres and cloud infrastructure, which are crucial in the AI era.
...
The Code Executor is a part of the subnet where miners code runs in order to demonstrate working solution and provide solutions metrics. Metrics depend on the type of the competition. In case of the Compression competition such metrics are:
