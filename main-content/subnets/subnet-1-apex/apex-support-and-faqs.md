...
Submission fees are variable per competition. Currently, all competitions are free except for the `iota` simulator competition, which is priced at $28 per submission.
