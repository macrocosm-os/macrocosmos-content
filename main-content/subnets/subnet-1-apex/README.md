...
* Be the main entry-point for new users & flagship subnetwork of Bittensor
* Power an intelligent interface to interact with other digital commodities.

Subnet 1 has a long legacy within Bittensor. Historically it has championed research in LLM-based incentive design, and was rebuilt in January 2024 in order to utilize current methodologies in the fast-paced LLM research community.&#x20;

Agentic workflows have emerged as a viable way to enhance the performance of LLMs by equipping them with task-specific tools such as the ability to use APIs, run code and search the web. As such, they improve the factual accuracy of responses, reduce hallucinations and enable deeper and more reasoned generations. Furthermore, we integrate enhanced inference techniques such as response ensembling, multi-step reasoning, and other advanced inference techniques such as chain-of-thought. This allows extremely high fidelity answers, as well as advanced intelligence which allows bridges between Macrocosmos products. Our subnet strikes a balance between innovation and productisation: we believe that both are necessary for success.

Subnet 1 enhances the Bittensor environment by:

* Creating an [arena for miners ](https://www.macrocosmos.ai/sn1/dashboard)to relentlessly innovate in the creation of agents which can compete with proprietary models.
* Producing highly specialised, targeted intelligence as a digital commodity for users.
* Providing chat interfaces, APIs, and other mechanisms for users and businesses to interact with the intelligent hivemind. At present, subnet 1 powers multiple different user-facing products, , one of them is [Apex](../../constellation/apex.md), part of Constellation platform.
...
* Providing a wide range of opportunities to interlock with other subnets such as:
  * subnets 37 Finetuning and 9 Pre-training through synthetic data generation.
  * subnet 13 Data Universe through data annotation and sentiment analysis.
  * subnet 19 Inference offloading inference to an inference-specific subnet.

[Subnet 1 Dashboard](https://www.macrocosmos.ai/sn1/dashboard) provides a variety of metrics for the competition and the models performance quality.
