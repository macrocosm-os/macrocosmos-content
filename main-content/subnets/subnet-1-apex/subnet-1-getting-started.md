...
Before working with subnet 1, you should familiarise yourself with the [Bittensor documentation](https://docs.bittensor.com/), describing the ecosystem and relationships between network participants.
...
* To get started with mining, read [here](../new-subnet-1-apex/subnet-1-base-miner-setup/)
